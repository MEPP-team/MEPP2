 ...
 * \param[in] is_g_2_manifold Boolean to avoid costly checks when 
 *            the input g is 2-manifold. If you do not know, chose false.
 ...
 */
      ...
      )
  {
    ...
    for (auto edge_it = edge_range_mesh.begin(); edge_it != edge_range_mesh.end(); ++edge_it)
    {
      ...
      {
        bool is_a_2_manifold_collapse = is_g_2_manifold || 
                                        Helpers::is_2_manifold_edge(*edge_it);
        bool edge_ok_for_collapse = is_g_2_manifold ||
