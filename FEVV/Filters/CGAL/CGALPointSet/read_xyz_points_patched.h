...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/Point_set_processing_3/include/CGAL/IO/read_xyz_points.h $
...
#endif
{
  ...
  std::size_t outputPointsNbr = 0; // MEPP2 PATCH
      ...
      if (iss >> iformat(x) >> iformat(y) >> iformat(z))
        {
          ...
          *output++ = point;
          ...
          if (has_normals)
            put(normal_map, outputPointsNbr-1, normal); // normal_map[index] = normal
#endif // MEPP2 PATCH
