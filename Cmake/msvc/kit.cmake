...
if (CMAKE_CXX_COMPILER_VERSION VERSION_GREATER "19")
	if (CMAKE_SIZEOF_VOID_P EQUAL 8) # 64 bits
		if (NOT DEFINED ENV{APPVEYOR})
			...
			include("${CMAKE_CURRENT_LIST_DIR}/kit_vs2015-64_v01.cmake") # vs2015-64 (actual kit)
		else()
			message("--> VS2015 64 KIT used (MSVC ${CMAKE_CXX_COMPILER_VERSION}) - AppVeyor packages")
			include("${CMAKE_CURRENT_LIST_DIR}/kit_vs2015-64_v01-AppVeyor.cmake") # vs2015-64 (actual kit)
		endif()
