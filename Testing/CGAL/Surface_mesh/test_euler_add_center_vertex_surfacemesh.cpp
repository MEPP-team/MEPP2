...
const char *outputFileName = "add_center_vertex_surfacemesh_output.off";

//------------------------------------------------------------------------------

void
test_euler_add_center_vertex_surface_mesh(std::string filename)
{
...
main(int narg, char **argv)
{
  ...
  // run test
  test_euler_add_center_vertex_surface_mesh(argv[1]);
