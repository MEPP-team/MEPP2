                 ...
                 int targetIndex )
{
  ...
  vertex_iterator v = vertices(g).first; // g.vertices_begin() cannot be used here, because it is not defined in any concept

  vertex_descriptor dst = *boost::next(v, targetIndex);
