...
class TextureImageDemoDialog : public BasePluginDialogQt
{
  Q_OBJECT

public:
  explicit TextureImageDemoDialog(QWidget *parent = 0);
  ~TextureImageDemoDialog();
