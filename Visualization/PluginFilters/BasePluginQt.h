...
public:
  ...
  std::string chooseDatastructureMsgBox(void)
  {
    ...
    QPushButton *polyhedron_button = msgbox.addButton("Polyhedron_3", QMessageBox::ResetRole);
    QPushButton *surfacemesh_button = msgbox.addButton("Surface_mesh", QMessageBox::ResetRole);
