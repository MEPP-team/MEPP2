...
protected:
  ...
  std::vector< std::vector< osg::ref_ptr< osg::Geometry > > > v_geometries,
      v_geometriesL, v_geometriesP, v_geometries_edges, v_geometries_vertices, v_geometries_normals, v_geometries_custom_vectors;
  std::vector< std::vector< osg::ref_ptr< osg::Vec3Array > > > v_vertexArrays,
      v_vertexArrays_edges, v_vertexArrays_vertices, v_vertexArrays_normals, v_vertexArrays_custom_vectors;
  ...
  std::vector< std::vector< osg::ref_ptr< osg::Vec4Array > > > v_colorsArrays,
      v_colorsArrays_edges, v_colorsArrays_vertices, v_colorsArrays_normals, v_colorsArrays_custom_vectors;
